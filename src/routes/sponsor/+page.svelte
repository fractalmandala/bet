...
<div class="r-r-r-r container-row istop l1">
	<div class="c-c-c-c l1a">
		...
		<h3>Read more about our work so far, planned roadmap, and contribute to the culture engine at our crowdfunding campaign live at Dharmic Crowdfunding.</h3>
...
.l1b img { object-fit: cover; width: 100%; height: 100%;}

@media screen and (min-width: 768px) {
	.l1{ height: 100%; justify-content: center;}
	.istop { padding-top: 120px;}
	.l1a { width: 60%; height: 100%; padding-right: 48px;}
	.l1b { width: 40%; height: 100%;}
	h3 { margin-top: 12px; margin-bottom: 32px;}
